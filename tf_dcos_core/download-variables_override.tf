variable "dcos_download_path" {
  ...
  default = {
   ...
   "1.9.6"      = "https://downloads.mesosphere.com/dcos-enterprise/stable/1.9.6/dcos_generate_config.ee.sh"
   "1.9.7"      = "https://downloads.mesosphere.com/dcos-enterprise/stable/1.9.7/dcos_generate_config.ee.sh"
   "1.9.8"      = "https://downloads.mesosphere.com/dcos-enterprise/stable/1.9.8/dcos_generate_config.ee.sh"
